...
| **REQ-005** | P2 | User can generate cover letter (standalone or from generation); **batch** tailor up to **3 jobs** per request within plan limits. | [03-resume-tailoring.md](./03-resume-tailoring.md) | `cover-letter`, `batch-generate` |
