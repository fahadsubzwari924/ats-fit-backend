...
export class AtsMatchController {
  ...
  @ApiResponse({ status: 200, description: 'ATS score calculated', type: AtsScoreResponseDto })
  async calculateAtsScore(
    ...
    return this.atsMatchService.calculateAtsScore(dto.jobDescription, resumeFile);
  }
} 