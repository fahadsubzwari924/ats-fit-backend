...
export class FixPaymentHistoryColumns1728519001000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        const hasLemonSqueezyId = await queryRunner.hasColumn('payment_history', 'lemon_squeezy_id');
        const hasLemonSqueezyPayload = await queryRunner.hasColumn('payment_history', 'lemon_squeezy_payload');
        ...
        if (hasLemonSqueezyId) {
            ...
            // Update the index
            await queryRunner.query(`DROP INDEX IF EXISTS "IDX_334a2d6c667ce10393a1cb6e9c"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        const hasExternalPaymentId = await queryRunner.hasColumn('payment_history', 'external_payment_id');
        const hasPaymentGatewayResponse = await queryRunner.hasColumn('payment_history', 'payment_gateway_response');
        ...
        if (hasExternalPaymentId) {
            ...
            await queryRunner.query(`CREATE INDEX "IDX_334a2d6c667ce10393a1cb6e9c" ON "payment_history" ("lemon_squeezy_id")`);
