...
async function bootstrap() {
  ...
  app.enableCors({
    ...
    allowedHeaders: [
      ...
      'X-Tailoring-Mode',
      'X-Keywords-Added',
      'X-Sections-Optimized',
      'X-Achievements-Quantified',
      'X-Optimization-Confidence',
      'X-Match-Score-Before',
      'X-Match-Score-After',
      'X-Match-Score-Delta',
      'X-Ats-Checks-Passed',
      'X-Ats-Checks-Total',
      'X-Bullets-Quantified-Before',
      'X-Bullets-Quantified-After',
      'X-Bullets-Quantified-Total',
    ],
    exposedHeaders: [
      'X-Resume-Generation-Id',
      'X-Filename',
