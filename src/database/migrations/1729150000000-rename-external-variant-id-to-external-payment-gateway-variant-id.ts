  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    if (hasOldColumn) {
      ...
      await queryRunner.query(
        `ALTER TABLE "subscription_plans" RENAME COLUMN "external_variant_id" TO "external_payment_gateway_variant_id"`,
      );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    const hasNewColumn = await queryRunner.hasColumn(
      'subscription_plans',
      'external_payment_gateway_variant_id',
    );
    ...
    if (hasNewColumn) {
      ...
      await queryRunner.query(
        `ALTER TABLE "subscription_plans" RENAME COLUMN "external_payment_gateway_variant_id" TO "external_variant_id"`,
      );
    }
  }
}
