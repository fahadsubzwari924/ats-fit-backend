...
export class CreatePaymentSystemTables1759551000000
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."subscriptions_status_enum" AS ENUM('active', 'cancelled', 'expired', 'paused', 'past_due')`,
    );
    ...
    // Create indexes
    await queryRunner.query(
      `CREATE INDEX "IDX_subscription_plans_lemon_squeezy_variant_id" ON "subscription_plans" ("lemon_squeezy_variant_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_payment_history_lemon_squeezy_id" ON "payment_history" ("lemon_squeezy_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD CONSTRAINT "FK_subscriptions_subscription_plan_id" FOREIGN KEY ("subscription_plan_id") REFERENCES "subscription_plans"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "payment_history" ADD CONSTRAINT "FK_payment_history_user_id" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "payment_history" ADD CONSTRAINT "FK_payment_history_subscription_plan_id" FOREIGN KEY ("subscription_plan_id") REFERENCES "subscription_plans"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "payment_history" DROP CONSTRAINT "FK_payment_history_subscription_plan_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "payment_history" DROP CONSTRAINT "FK_payment_history_user_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" DROP CONSTRAINT "FK_subscriptions_subscription_plan_id"`,
    );
    await queryRunner.query(
    ...
    // Drop indexes
    await queryRunner.query(
      `DROP INDEX "public"."IDX_payment_history_subscription_plan_id_created_at"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_payment_history_user_id_status"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_payment_history_lemon_squeezy_id"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_subscriptions_user_id_status"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_subscriptions_lemon_squeezy_id"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_subscription_plans_lemon_squeezy_variant_id"`,
    );
